...
import 'package:shared_ui/components/validate/required.dart';
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        Space.h(
          widget.title.isEmpty ? 0 : (AppSetting.isTablet(context) ? 30 : 15),
        ),
        ClipRRect(
          ...
          child: TextFormField(
            ...
            style: MyTheme.style.subtitle.copyWith(
              fontSize:
                  AppSetting.setFontSize(widget.fontSize ?? 36) -
            ...
            decoration: InputDecoration(
              errorStyle: MyTheme.style.subtitle.copyWith(
                fontSize:
                    AppSetting.setFontSize((widget.fontSize! - 10)) -
                    (AppSetting.isTablet(context) ? 4 : 0),
              ...
              hintStyle: MyTheme.style.subtitle.copyWith(
                fontSize:
                    AppSetting.setFontSize((widget.fontSize! - 5)) -
                    (AppSetting.isTablet(context) ? 4 : 0),
